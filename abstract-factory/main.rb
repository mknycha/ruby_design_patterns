Dir['classes/*.rb', 'classes/weapons/*.rb', 'classes/armors/*.rb'].each { |file| require_relative file }
...
puts "Created equipment for wizard: #{equipment.to_s}"

equipment = create_character_equipment(WarriorEquipmentFactory.new)
puts "Created equipment for warrior: #{equipment.to_s}"
